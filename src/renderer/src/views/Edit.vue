...
<template>
  <div class="flex flex-col h-full overflow-hidden studio-canvas-bg text-foreground">
    <div class="flex-1 relative min-h-0 overflow-hidden border-b border-border/60 px-3 md:px-5 py-1.5 md:py-6">
      <div
        v-if="error"
          ...
          <div class="flax-composer-input-row flex items-end gap-2">
            <div class="flex-1 relative">
              ...
              <button
                ...
                :style="{ opacity: (!prompt.trim() || !baseImage) ? 0.4 : 1, cursor: (!prompt.trim() || !baseImage) ? 'not-allowed' : 'pointer' }"
                title="Inpaint"
              >
