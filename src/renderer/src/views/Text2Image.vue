...
<template>
  <div class="flex flex-col h-full overflow-hidden studio-canvas-bg text-foreground">
    <!-- Preview Area -->
    <div class="flex-1 relative min-h-0 overflow-hidden px-3 md:px-5 py-1.5 md:py-6">
      <div
        v-if="error"
      ...
      <div class="flex h-full w-full min-h-0 flex-col">
        ...
        >
          ...
          >
            ...
            >
              <span class="empty-preview-brand">StableUI</span>
    ...
    <div class="shrink-0 px-3 md:px-5 pb-3 md:pb-4 pt-2 md:pt-3">
      <div class="stable-generation-controls relative overflow-visible rounded-3xl">
        <!-- Quick Controls Row -->
        <div
                  ...
                  <div class="flex-1">
                    ...
                    <div class="flex gap-2 flex-wrap">
                      <div
                        ...
                        :key="idx"
                        class="stable-image-card group"
                      >
                        <img :src="getFileUrl(img)" />
                        <button
                          @click="removePMImage(idx)"
                          class="stable-image-remove"
                          title="Remove image"
                        >
                          <X class="w-3 h-3" />
                        </button>
              ...
              <div v-if="activeTab === 'controlnet'" class="space-y-3">
                <div class="flex flex-col md:flex-row items-start gap-3">
                  <div>
                    ...
                    <div class="stable-image-card group">
                      <img
          ...
          <div class="flax-composer-input-row flex items-end gap-2">
            <div class="flex-1 relative">
              <textarea
                ...
                class="flax-composer-textarea w-full resize-none metal-surface !rounded-xl px-3 py-2 md:px-5 md:py-4 pr-[48px] text-[15px] md:text-lg leading-6 md:leading-7 text-foreground transition-shadow duration-150 focus:outline-none focus:ring-1 focus:ring-primary/40 placeholder:text-muted-foreground/50 overflow-y-auto"
                :style="{
              ...
              <button
                ...
                class="flax-composer-send metal-icon-button"
                style="position: absolute; right: 14px; bottom: 20px; display: flex; align-items: center; justify-content: center; width: 32px; height: 32px; border-radius: 8px; opacity: 1; cursor: pointer"
                :style="{ opacity: prompt.trim() ? undefined : 0.4, cursor: prompt.trim() ? undefined : 'not-allowed' }"
                title="Generate"
              >
              ...
              <button
                ...
                :tapped="buttonMotion.tapped"
                @click="handleCancel"
                class="metal-icon-button"
                style="position: absolute; right: 14px; bottom: 20px; display: flex; align-items: center; justify-content: center; width: 32px; height: 32px; border-radius: 8px"
                title="Cancel"
              >
                <X class="w-4.5 h-4.5" />
              </button>
