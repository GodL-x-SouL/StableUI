...
<template>
  <div class="flex flex-col h-full overflow-hidden studio-canvas-bg text-foreground">
    ...
    <div class="shrink-0 bg-card/70 px-3 md:px-5 pb-3 md:pb-4 pt-2 md:pt-3">
      <div class="stable-generation-controls relative overflow-visible rounded-3xl border border-border/70 bg-card/85 shadow-[0_12px_34px_rgba(130,130,255,0.14)] backdrop-blur">
        <!-- Quick Controls Row -->
