...
const itemClasses =
  'flax-select-item relative flex min-w-0 cursor-default select-none items-center rounded-lg px-2 py-1.5 text-[13px] font-medium tracking-[-0.01em] outline-none data-[highlighted]:bg-muted/60 data-[state=checked]:font-semibold data-[disabled]:pointer-events-none data-[disabled]:opacity-50 transition-colors'
...
<template>
  ...
  >
    <SelectTrigger :class="[triggerClasses, sizeClasses[size], props.class]">
      <SelectValue :placeholder="placeholder" class="min-w-0 flex-1">
        {{ displayValue }}
      </SelectValue>
      <SelectIcon>
