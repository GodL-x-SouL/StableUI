...
const PRESETS_STORAGE_KEY = 'stable-config-presets'
...
const BUILTIN_PRESETS: ConfigPreset[] = [
  ...
  },
  {
    ...
    createdAt: 0,
    updatedAt: 0,
    config: presetConfig({ loadMode: 'split', cfgScale: 0, guidance: 0, steps: 8, width: 1024, height: 1024, sampler: 'euler', scheduler: 'discrete', flashAttention: true, cpuOffload: true })
  },
  {
